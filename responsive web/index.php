  ...
  <body ng-app="ngAnimate">
    <div class="container" id="querybox">
      ...
      <form class="form-horizontal">
        ...
        <span class="col-sm-3"></span><p id="keyword_empty" class="col-sm-5" style="padding-left:5%;display:block;color:red;fontsize:80%;"></p></div>
        <div class="form-group"><span class="col-sm-1"></span>
          <label class="control-label col-sm-2" for="category">Category</label>
          <div class="col-sm-6"><select class="form-control" id="category">
            <option value="default" selected = "selected" id="category_default">default</option>
        ...
        <div class="form-group"><span class="col-sm-1"></span>
          ...
          <div class="col-sm-6"><input type="text" class="form-control" id="distance" placeholder="10" value="10" pattern="^[0-9]+(.[0-9]*)?$" required></div>
        <span class="col-sm-3"></span>
        <span class="col-sm-3"></span>
        <p id="distance_empty" class="col-sm-5" style="padding-left:5%;display:block;color:red;fontsize:80%;"></p></div>
        <div class="form-group"><span class="col-sm-1"></span>
          ...
          <div class="col-sm-8">
            ...
            <p id="location_empty" style="padding-left:5%;display:block;color:red;fontsize:80%;"></p>
          </div>
        ...
        <div class="form-group"><span class="col-sm-1"></span>
          ...
          <button type="button" class="btn btn-default" id="clear" ng-click='place_page=false;fav_page=false;detail_page=false;'>Clear</button>
    ...
    <div id='res_place_detail' ng-show="detail_page" class="res_detail">
      ...
      <div id='detail_map'>
        <form>
          ...
          <div class="form-row" style="width:34px;"><button class="form-control btn btn-default" style="padding:0;margin:0;position:relative;left:30px;" id="streetview_switch"><img style="width:100%;" id="map_toggle" src="https://cdn.dribbble.com/users/244628/screenshots/1303745/pegman.png"></button></div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#clear").click(function(){
          ...
          $("#distance_empty").html("");
          $("#location_empty").html("");
          $("#category_default").prop("selected","selected");
          $("#keyword").val("");
          $("#distance").val("10");
          $("#details").prop("style","display:none;");
          $("#list").prop("style","display:none;");
          $("#fromhere").prop("checked",true);
          $("#location").val("");
        ...
        function ShowMap(lat, lng){
          $("#map_toggle").prop("src","https://cdn.dribbble.com/users/244628/screenshots/1303745/pegman.png");
          var mapOptions = {
            zoom: 13,
        ...
        $("#streetview_switch").click(function(){
          ...
          if (toggle == false) {
            $("#map_toggle").prop("src","https://png.icons8.com/color/1600/google-maps.png");
        ...
        $("#search").click(function(){
          ...
          var haul = false;
          if($("#keyword").val()==""){
            $("#keyword_empty").html("Please enter a keyword");
            haul = true;
          }
          if($("#distance").val()==""){
            $("#distance_empty").html("Please enter a distance");
            haul = true;
          }
          if(/^[0-9]+(.[0-9]*)?$/.test($("#distance").val())==false){
            $("#distance_empty").html("Please enter a number");
            haul = true;
          }
          if($("#fromlocation").prop("checked")==true && $("#location").val()==""){
            $("#location_empty").html("Please enter a location");
            haul = true;
          }
          if(haul)
            return false;
